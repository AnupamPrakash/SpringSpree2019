...
public class SpotlightFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v=inflater.inflate(R.layout.spotlight_fragment,container,false);
        recyclerView = v.findViewById(R.id.spotlightlist);
    ...
    private void displayData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, ApiClient.ATTRACTIONS_URL,
...
//        RequestQueue requestQueue = Volley.newRequestQueue(stringRequest,tag_string_req);
        ...
        progressdialog.show();
//        Toast.makeText(getActivity(), ""+ApiClient.ATTRACTIONS_URL, Toast.LENGTH_SHORT).show();
    }
}
